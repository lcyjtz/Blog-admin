...
<!--      用户身份-->
      ...
      >
        <template slot-scope="scope">
          <el-tag size="medium">{{ scope.row.powertype}}</el-tag>
        </template>
      </el-table-column>
...
<script>
  import {findUserList, updateSilenceById,updateUserInfo,logicDeleteUserById,  addUser , getRoleList} from "../../api/users";
  ...
  export default {
    ...
    methods: {
      ...
      handleSizeChange(val) {
        ...
        this.UserQueryVO.size=val;
        this.getUserList();
      },
      //当页面改边的时候
      handleCurrentChange(val) {
        this.UserQueryVO.current=val;
        this.getUserList();
      },
      async getUserList(){
